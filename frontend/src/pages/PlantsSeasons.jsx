...
const CropsPage = ({ language = 'ar' }) => {
  ...
  const plants = useMemo(() => ([
    {
      ...
      seasonText: isArabic ? "طوال العام" : "All year",
    ...
    },
    {
      ...
      seasonText: isArabic ? "الربيع، الصيف، الخريف" : "Spring, Summer, Autumn",
    ...
    },
    {
      ...
      seasonText: isArabic ? "الشتاء والربيع" : "Winter and Spring",
    ...
    },
    {
      ...
      seasons: ["Summer"],
      seasonText: isArabic ? "الصيف (يُحصد صيفاً)" : "Summer",
    ...
    },
    {
      ...
      seasonText: isArabic ? "الصيف والخريف" : "Summer and Autumn",
    ...
    },
    {
      ...
      seasonText: isArabic ? "الربيع والصيف (يُحصد)" : "Spring and Summer",
    ...
    },
    {
      ...
      seasons: ["Spring"],
      seasonText: isArabic ? "الربيع (يُحصد ربيعاً)" : "Spring",
    ...
    },
    {
      ...
      seasonText: isArabic ? "الشتاء، الربيع، الصيف" : "Winter, Spring, Summer",
      modalImg: "images/potato.jpg",
      growth: isArabic ? "90 - 120 يوم" : "90 - 120 days",
      fertilizer: isArabic ? "NPK + بوتاسيوم + كالسيوم" : "NPK + Potassium + Calcium",
      totalCost: 27000,
      cost: isArabic ? "متوسط تكلفة الفدان: 25,000 - 30,000 جنيه" : "Average cost per feddan: 25,000 - 30,000 EGP",
      method: isArabic ? "البطاطس من أهم المحاصيل الشتوية في مصر، وتحتاج إلى تربة جيدة التهوية ويفضل الأراضي الرملية أو الطميية الخفيفة. يتم تجهيز الأرض جيدًا بالحرث والتسوية، ثم تقطيع التقاوي وتركها لتجف قبل الزراعة. تُزرع الدرنات على عمق مناسب مع الاهتمام بالري المنتظم دون تغريق، ويُضاف السماد على مراحل خلال النمو حتى الوصول إلى حجم مناسب للدرنات." : "Potatoes are one of the most important crops in Egypt. They require well-aerated soil. The land is prepared through plowing and leveling, then seed tubers are cut and left to dry before planting. Tubers are planted at proper depth with regular irrigation and staged fertilization until maturity.",
      cultivationSteps: [
        { title: isArabic ? "تجهيز الأرض" : "Land preparation", text: isArabic ? "حرث الأرض مرتين أو ثلاث مرات وتنعيمها جيدًا مع تسوية السطح." : "Plow the land 2–3 times and level it properly." },
        { title: isArabic ? "تقطيع التقاوي" : "Seed cutting", text: isArabic ? "تقطيع درنات البطاطس إلى قطع تحتوي على عيون وتركها لتجف يومين." : "Cut seed tubers into pieces with eyes and let them dry for 2 days." },
        { title: isArabic ? "الزراعة" : "Planting", text: isArabic ? "زراعة الدرنات على عمق 10–15 سم وبين كل نبات 25–30 سم." : "Plant tubers at 10–15 cm depth with 25–30 cm spacing." },
        { title: isArabic ? "الري" : "Irrigation", text: isArabic ? "الري المنتظم كل 5–7 أيام مع تجنب التغريق." : "Irrigate every 5–7 days without overwatering." },
        { title: isArabic ? "التسميد" : "Fertilization", text: isArabic ? "إضافة NPK على دفعات خلال فترة النمو." : "Apply NPK fertilizers in stages during growth." },
        { title: isArabic ? "الحصاد" : "Harvesting", text: isArabic ? "يتم الحصاد بعد اصفرار الأوراق وجفافها." : "Harvest when leaves turn yellow and dry." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "تقاوي البطاطس" : "Seed tubers", amount: 13000, details: isArabic ? "شراء تقاوي بطاطس معتمدة عالية الجودة." : "شراء درنات بطاطس عالية الجودة" },
        { id: 2, title: isArabic ? "تجهيز الأرض" : "Land preparation", amount: 4000, details: isArabic ? "حرث وتسوية الأرض." : "Plowing and leveling" },
        { id: 3, title: isArabic ? "سماد عضوي" : "Organic manure", amount: 3000, details: isArabic ? "إضافة سماد بلدي متحلل." : "Organic manure" },
        { id: 4, title: isArabic ? "أسمدة كيميائية" : "Fertilizers", amount: 4000, details: isArabic ? "NPK + عناصر صغرى." : "NPK + micronutrients" },
        { id: 5, title: isArabic ? "مبيدات" : "Pesticides", amount: 1500, details: isArabic ? "مكافحة الآفات والأمراض." : "Pest control" },
        { id: 6, title: isArabic ? "عمالة وري" : "Labor & irrigation", amount: 1500, details: isArabic ? "تكاليف العمالة والري." : "Labor and irrigation costs" }
      ]
    },
    {
      id: 16,
      ...
      seasons: ["Spring"],
      seasonText: isArabic ? "الربيع (يحصد أبريل - مايو)" : "Spring (Harvested April - May)",
      ...
      totalCost: 9500,
      cost: isArabic ? "متوسط تكلفة الفدان: 9,000 - 10,000 جنيه" : "Average cost per feddan: 9,000 - 10,000 EGP",
      method: isArabic ? "القمح من أهم المحاصيل الاستراتيجية في مصر، ويزرع في الأراضي الطميية الثقيلة والخفيفة. يتم تجهيز الأرض جيدًا بالحرث والتسوية ثم زراعة التقاوي إما نثرًا أو بالتسطير. يحتاج القمح إلى ري منتظم في المراحل الأولى ثم تقليل الري قبل الحصاد. كما يتم إضافة الأسمدة النيتروجينية على دفعات لضمان نمو جيد وزيادة الإنتاج." : "Wheat is one of the most important strategic crops in Egypt. It is grown in both heavy and light clay soils. The land is prepared through plowing and leveling, and seeds are sown either by broadcasting or drilling. Wheat requires regular irrigation in early stages, then reduced watering before harvest. Nitrogen fertilizers are applied in stages to ensure good growth and higher yield.",
      cultivationSteps: [
        { title: isArabic ? "تجهيز الأرض" : "Land preparation", text: isArabic ? "حرث الأرض جيدًا مرتين أو أكثر مع تسويتها." : "Plow the land 2 or more times and level it properly." },
        { title: isArabic ? "زراعة التقاوي" : "Sowing", text: isArabic ? "زراعة البذور نثرًا أو بالتسطير بمعدل مناسب." : "Sow seeds by broadcasting or drilling at proper rate." },
        { title: isArabic ? "الري" : "Irrigation", text: isArabic ? "الري المنتظم خاصة في بداية النمو." : "Regular irrigation especially in early growth." },
        { title: isArabic ? "التسميد" : "Fertilization", text: isArabic ? "إضافة الأسمدة النيتروجينية على دفعات." : "Apply nitrogen fertilizers in stages." },
        { title: isArabic ? "مكافحة الحشائش" : "Weed control", text: isArabic ? "إزالة الحشائش أو استخدام مبيدات مناسبة." : "Remove weeds or use herbicides." },
        { title: isArabic ? "الحصاد" : "Harvesting", text: isArabic ? "يتم الحصاد عند اصفرار السنابل وجفافها." : "Harvest when spikes turn yellow and dry." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "تقاوي القمح" : "Seeds", amount: 3200, details: isArabic ? "شراء بذور قمح معتمدة." : "Certified wheat seeds" },
        { id: 2, title: isArabic ? "تجهيز الأرض" : "Land preparation", amount: 1500, details: isArabic ? "حرث وتسوية الأرض." : "Plowing and leveling" },
        { id: 3, title: isArabic ? "سماد عضوي" : "Organic manure", amount: 1500, details: isArabic ? "إضافة سماد بلدي." : "Organic manure" },
        { id: 4, title: isArabic ? "أسمدة كيميائية" : "Fertilizers", amount: 2000, details: isArabic ? "نيتروجين + فوسفور." : "Nitrogen + phosphorus" },
        { id: 5, title: isArabic ? "مبيدات" : "Pesticides", amount: 700, details: isArabic ? "مكافحة الحشائش والآفات." : "Weed and pest control" },
        { id: 6, title: isArabic ? "عمالة وري" : "Labor & irrigation", amount: 600, details: isArabic ? "تكاليف العمالة والري." : "Labor and irrigation costs" }
      ]
    },
    {
      id: 17,
      ...
      totalCost: 170000,
      cost: isArabic ? "متوسط تكلفة الفدان: 150,000 - 180,000 جنيه (سنة التأسيس)" : "Average cost per feddan: 150,000 - 180,000 EGP (first year)",
      method: isArabic ? "الموز من المحاصيل الشرهة جدًا للمياه والعناصر الغذائية، ويحتاج إلى تربة جيدة الصرف ويفضل الأراضي الرملية أو الطميية الخفيفة. يتم تجهيز الأرض بعمق كبير وإضافة كميات كبيرة من السماد العضوي، ثم زراعة الخلفات (الفسائل) على مسافات واسعة. يحتاج النبات إلى ري منتظم بكميات كبيرة، ويتم اختيار خلفة واحدة قوية لكل نبات لضمان إنتاج جيد، مع إزالة باقي الخلفات الزائدة." : "Banana is a heavy feeder crop requiring large amounts of water and nutrients. It prefers well-drained sandy or light loamy soils. The land is deeply prepared and enriched with organic manure, then offshoots are planted with wide spacing. The plant requires heavy irrigation, and only one strong offshoot is kept per plant to ensure good production.",
      cultivationSteps: [
        { title: isArabic ? "تجهيز الأرض العميق" : "Deep land preparation", text: isArabic ? "حرث الأرض بعمق كبير مع إضافة سماد عضوي بكميات كبيرة." : "Deep plowing with large amounts of organic manure." },
        { title: isArabic ? "زراعة الخلفات" : "Planting offshoots", text: isArabic ? "زراعة خلفات سليمة وخالية من الأمراض على مسافات 3×3 متر." : "Plant healthy offshoots at 3x3 meter spacing." },
        { title: isArabic ? "الري الغزير المنتظم" : "Heavy irrigation", text: isArabic ? "الري بكميات كبيرة وبانتظام لأن النبات يستهلك مياه كثيرة." : "Frequent heavy irrigation due to high water demand." },
        { title: isArabic ? "اختيار خلفة واحدة" : "Offshoot selection", text: isArabic ? "ترك خلفة واحدة قوية لكل نبات وإزالة الباقي." : "Keep one strong offshoot and remove others." },
        { title: isArabic ? "التسميد المستمر" : "Continuous fertilization", text: isArabic ? "إضافة النيتروجين والبوتاسيوم على مراحل." : "Apply nitrogen and potassium in stages." },
        { title: isArabic ? "الحصاد" : "Harvesting", text: isArabic ? "يتم الحصاد بعد اكتمال نمو السباطة." : "Harvest when the bunch is fully developed." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "خلفات الموز" : "Banana offshoots", amount: 55000, details: isArabic ? "شراء خلفات جيدة ومعتمدة." : "شراء فسائل موز عالية الجودة" },
        { id: 2, title: isArabic ? "تجهيز الأرض" : "Land preparation", amount: 30000, details: isArabic ? "حرث عميق وتسوية." : "Deep plowing and leveling" },
        { id: 3, title: isArabic ? "سماد عضوي" : "Organic manure", amount: 30000, details: isArabic ? "كميات كبيرة من السماد البلدي." : "Large organic manure quantities" },
        { id: 4, title: isArabic ? "أسمدة كيميائية" : "Fertilizers", amount: 25000, details: isArabic ? "نيتروجين + بوتاسيوم." : "Nitrogen and potassium" },
        { id: 5, title: isArabic ? "مكافحة" : "Pesticides", amount: 15000, details: isArabic ? "مكافحة الحشرات والأمراض." : "Pest control" },
        { id: 6, title: isArabic ? "عمالة وري" : "Labor & irrigation", amount: 15000, details: isArabic ? "تكاليف الري والعمالة." : "Labor and irrigation costs" }
      ]
    },
    {
      id: 18,
      ...
      fertilizer: isArabic ? "سماد عضوي + NPK + كالسيوم + بوتاسيوم + عناصر صغرى" : "Organic manure + NPK + calcium + potassium + micronutrients",
      totalCost: 145000,
      cost: isArabic ? "متوسط تكلفة الفدان: 130,000 - 160,000 جنيه حسب نوع الشتلات ونظام الري" : "Average cost per feddan: 130,000 - 160,000 EGP depending on seedlings and irrigation system",
      method: isArabic ? "الفراولة محصول عالي القيمة لكنه حساس جدًا، ويحتاج تجهيز دقيق قبل الزراعة. تبدأ الزراعة بتجهيز الأرض وعمل مصاطب مرتفعة لتحسين الصرف، ثم تركيب شبكة تنقيط لأن انتظام الري مهم جدًا. بعد ذلك يتم فرد الملش البلاستيك لحماية الثمار وتقليل الحشائش، ثم زراعة الشتلات في فتحات منتظمة. خلال الموسم تحتاج الفراولة إلى تسميد متوازن، خاصة الكالسيوم والبوتاسيوم لتحسين جودة الثمار، مع متابعة مستمرة للأعفان والبياض الدقيقي والحشرات. يبدأ الحصاد عادة بعد حوالي 75 إلى 100 يوم ويستمر على دفعات." : "Strawberry is a high-value but sensitive crop that requires careful preparation. Cultivation starts with land preparation and raised beds for better drainage, followed by drip irrigation installation because water consistency is essential. Plastic mulch is then applied to protect fruits and reduce weeds, and seedlings are planted in regular holes. During the season, strawberries require balanced fertilization, especially calcium and potassium for fruit quality, with continuous monitoring for rots, powdery mildew, and pests. Harvest usually starts after about 75 to 100 days and continues in multiple pickings.",
      cultivationSteps: [
        { title: isArabic ? "تجهيز الأرض والمصاطب" : "Land and bed preparation", text: isArabic ? "حرث الأرض وتنعيمها جيدًا، ثم عمل مصاطب مرتفعة بعرض مناسب لتحسين الصرف وتقليل ملامسة الثمار للتربة." : "Plow and soften the soil, then form raised beds to improve drainage and reduce fruit contact with soil." },
        { title: isArabic ? "تركيب شبكة التنقيط" : "Drip irrigation setup", text: isArabic ? "تركيب خراطيم تنقيط على المصاطب لضمان وصول المياه بانتظام للجذور بدون تغريق." : "Install drip lines on beds to deliver water evenly to roots without waterlogging." },
        { title: isArabic ? "فرد الملش البلاستيك" : "Plastic mulch installation", text: isArabic ? "تغطية المصاطب بملش بلاستيك أسود أو فضي لتقليل الحشائش وحماية الثمار من التعفن." : "Cover beds with black or silver plastic mulch to reduce weeds and protect fruits from rot." },
        { title: isArabic ? "تجهيز وزراعة الشتلات" : "Seedling preparation and transplanting", text: isArabic ? "اختيار شتلات سليمة، وتطهير الجذور عند الحاجة، ثم زراعتها في فتحات الملش مع بقاء قلب الشتلة فوق سطح التربة." : "Select healthy seedlings, disinfect roots when needed, then plant through mulch holes while keeping the crown above soil level." },
        { title: isArabic ? "التسميد وبرنامج التغذية" : "Fertilization program", text: isArabic ? "إضافة NPK على دفعات، مع التركيز على الكالسيوم لتقليل تشوه الثمار والبوتاسيوم لتحسين الحجم والطعم." : "Apply NPK in doses, focusing on calcium to reduce fruit deformities and potassium to improve size and taste." },
        { title: isArabic ? "المكافحة والمتابعة" : "Protection and monitoring", text: isArabic ? "متابعة البياض الدقيقي والأعفان والعنكبوت الأحمر والمن، والرش عند ظهور الإصابة فقط لتقليل التكلفة." : "Monitor powdery mildew, rots, red spider mites, and aphids, spraying only when infection appears to reduce cost." },
        { title: isArabic ? "الجمع والفرز" : "Harvesting and sorting", text: isArabic ? "جمع الثمار الناضجة على دفعات متقاربة، ثم فرز الثمار السليمة واستبعاد التالفة قبل التعبئة." : "Pick ripe fruits frequently, then sort healthy fruits and remove damaged ones before packing." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "شتلات فراولة جيدة" : "Quality strawberry seedlings", amount: 55000, details: isArabic ? "أكبر بند تكلفة غالبًا؛ يشمل شراء شتلات قوية مناسبة للعروة وخالية من الأمراض." : "Usually the biggest cost item; includes strong disease-free seedlings suitable for the season." },
        { id: 2, title: isArabic ? "تجهيز الأرض والمصاطب" : "Land and raised beds preparation", amount: 14000, details: isArabic ? "حرث، تنعيم، تسوية، تخطيط، وعمل مصاطب مرتفعة مناسبة للزراعة." : "Plowing, softening, leveling, row planning, and forming raised planting beds." },
        { id: 3, title: isArabic ? "شبكة ري بالتنقيط" : "Drip irrigation system", amount: 18000, details: isArabic ? "خراطيم تنقيط ومستلزمات توصيل وصيانة بسيطة لضمان انتظام الري." : "Drip lines, fittings, and basic maintenance to ensure regular irrigation." },
        { id: 4, title: isArabic ? "ملش بلاستيك وتثبيت" : "Plastic mulch and installation", amount: 12000, details: isArabic ? "تغطية المصاطب بالملش لتقليل الحشائش وحماية الثمار وتحسين جودة الإنتاج." : "Covering beds with mulch to reduce weeds, protect fruits, and improve production quality." },
        { id: 5, title: isArabic ? "سماد عضوي قبل الزراعة" : "Organic manure before planting", amount: 13000, details: isArabic ? "كمبوست أو سماد بلدي متحلل لتحسين خصوبة التربة قبل الشتل." : "Compost or decomposed manure to improve soil fertility before transplanting." },
        { id: 6, title: isArabic ? "أسمدة ومغذيات خلال الموسم" : "Season fertilizers and nutrients", amount: 22000, details: isArabic ? "NPK، كالسيوم، بوتاسيوم، وأحماض أو عناصر صغرى حسب حالة النبات." : "NPK, calcium, potassium, acids, or micronutrients depending on plant condition." },
        { id: 7, title: isArabic ? "مكافحة أمراض وحشرات" : "Disease and pest control", amount: 14000, details: isArabic ? "مبيدات فطرية وحشرية عند الحاجة ضد الأعفان والبياض والعنكبوت الأحمر." : "Fungicides and insecticides when needed against rots, mildew, and red spider mites." },
        { id: 8, title: isArabic ? "جمع وفرز وتعبئة" : "Picking, sorting, and packing", amount: 12000, details: isArabic ? "عمالة جمع متكرر، فرز الثمار، وعبوات بسيطة للتسويق." : "Repeated picking labor, fruit sorting, and basic packaging for marketing." }
      ]
    },
    {
      id: 19,
      ...
      growth: isArabic ? "90 - 120 يوم" : "90 - 120 days",
      fertilizer: isArabic ? "سماد عضوي + فوسفور + بوتاسيوم + نيتروجين خفيف" : "Organic manure + phosphorus + potassium + light nitrogen",
      totalCost: 52000,
      cost: isArabic ? "متوسط تكلفة الفدان: 45,000 - 60,000 جنيه حسب نوع التقاوي والخدمة" : "Average cost per feddan: 45,000 - 60,000 EGP depending on seed type and field service",
      method: isArabic ? "البنجر من المحاصيل الجذرية التي تحتاج إلى تربة ناعمة ومفككة حتى تنمو الجذور بشكل منتظم بدون تشوهات. يتم تجهيز الأرض جيدًا بالحرث والتنعيم وإزالة القلاقيل، ثم زراعة البذور في سطور أو خطوط على عمق بسيط. بعد الإنبات يتم الخف لترك مسافة مناسبة بين النباتات، لأن الزحام يقلل حجم الجذور. يحتاج البنجر إلى ري منتظم بدون تغريق، وتسميد متوازن مع الاهتمام بالبوتاسيوم لتحسين جودة الجذور." : "Beetroot is a root crop that needs soft, loose soil so roots can grow uniformly without deformation. The land is well plowed, softened, and cleared of clods, then seeds are sown in rows at shallow depth. After germination, thinning is done to leave proper spacing between plants because overcrowding reduces root size. Beetroot needs regular irrigation without waterlogging and balanced fertilization, especially potassium, to improve root quality.",
      cultivationSteps: [
        { title: isArabic ? "تجهيز تربة ناعمة" : "Fine soil preparation", text: isArabic ? "حرث الأرض وتنعيمها جيدًا وإزالة القلاقيل والحجارة لأن البنجر محصول جذري يتأثر بأي عوائق في التربة." : "Plow and soften the soil well, removing clods and stones because beetroot roots are affected by soil obstacles." },
        { title: isArabic ? "تخطيط الأرض" : "Row layout", text: isArabic ? "تقسيم الأرض إلى سطور أو خطوط منتظمة بمسافات مناسبة لتسهيل الخف والعزيق والري." : "Divide the land into regular rows with proper spacing to make thinning, weeding, and irrigation easier." },
        { title: isArabic ? "زراعة البذور" : "Seed sowing", text: isArabic ? "زراعة البذور على عمق 1.5–2 سم تقريبًا، مع تغطية خفيفة حتى لا يتأخر الإنبات." : "Sow seeds at about 1.5–2 cm depth with light covering to avoid delayed germination." },
        { title: isArabic ? "الخف بعد الإنبات" : "Thinning after germination", text: isArabic ? "بعد ظهور 3–4 أوراق يتم إزالة النباتات الزائدة وترك مسافة 10–15 سم بين النباتات لتكوين جذور جيدة." : "After 3–4 leaves appear, remove extra plants and leave 10–15 cm spacing for good root formation." },
        { title: isArabic ? "الري المنتظم" : "Regular irrigation", text: isArabic ? "الحفاظ على رطوبة ثابتة للتربة بدون تغريق، لأن الجفاف يسبب خشونة الجذور والتغريق يسبب أعفان." : "Maintain steady soil moisture without waterlogging, as drought makes roots rough and excess water causes rot." },
        { title: isArabic ? "التسميد المتوازن" : "Balanced fertilization", text: isArabic ? "استخدام فوسفور في البداية لتنشيط الجذور، ثم بوتاسيوم لتحسين الحجم والجودة، مع نيتروجين خفيف بدون زيادة." : "Use phosphorus early for root development, then potassium for size and quality, with light nitrogen without excess." },
        { title: isArabic ? "الحصاد والفرز" : "Harvesting and sorting", text: isArabic ? "يتم الحصاد عندما تصل الجذور للحجم المناسب، ثم تُفرز الجذور السليمة وتُزال الأوراق الزائدة قبل التسويق." : "Harvest when roots reach market size, then sort healthy roots and remove extra leaves before marketing." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "تقاوي البنجر" : "Beetroot seeds", amount: 9000, details: isArabic ? "شراء بذور جيدة بنسبة إنبات عالية، ويفضل اختيار صنف مناسب للسوق والحجم المطلوب." : "Buying good seeds with high germination, preferably a variety suitable for the market and desired root size." },
        { id: 2, title: isArabic ? "تجهيز وتنعيم الأرض" : "Land preparation and softening", amount: 9500, details: isArabic ? "حرث، تنعيم، تسوية، وإزالة القلاقيل لتقليل تشوه الجذور." : "Plowing, softening, leveling, and removing clods to reduce root deformation." },
        { id: 3, title: isArabic ? "زراعة وخف وعزيق" : "Sowing, thinning, and weeding", amount: 6500, details: isArabic ? "عمالة زراعة البذور، ثم خف النباتات الزائدة وتنظيف الحشائش في بداية النمو." : "Labor for seed sowing, thinning extra plants, and early weed cleaning." },
        { id: 4, title: isArabic ? "سماد عضوي قبل الزراعة" : "Organic manure before planting", amount: 8000, details: isArabic ? "كمبوست أو سماد بلدي متحلل لتحسين بناء التربة وتهوية منطقة الجذور." : "Compost or decomposed manure to improve soil structure and root-zone aeration." },
        { id: 5, title: isArabic ? "أسمدة فوسفور وبوتاسيوم" : "Phosphorus and potassium fertilizers", amount: 11000, details: isArabic ? "فوسفور لتقوية الجذور، وبوتاسيوم لتحسين حجم وجودة الجذر." : "Phosphorus for root strength and potassium to improve root size and quality." },
        { id: 6, title: isArabic ? "ري ومتابعة رطوبة" : "Irrigation and moisture follow-up", amount: 4500, details: isArabic ? "تنظيم الري طوال الموسم لتجنب تشقق أو خشونة الجذور." : "Managing irrigation throughout the season to avoid root cracking or roughness." },
        { id: 7, title: isArabic ? "مكافحة أمراض وحشرات" : "Disease and pest control", amount: 5000, details: isArabic ? "مكافحة أعفان الجذور والحشرات عند ظهور الإصابة، بدون رش زائد لتقليل التكلفة." : "Control root rots and insects when infection appears, without excessive spraying to reduce cost." },
        { id: 8, title: isArabic ? "حصاد وفرز ونقل" : "Harvesting, sorting, and transport", amount: 6500, details: isArabic ? "عمالة تقليع الجذور، فرزها، وتنظيفها ونقلها للسوق." : "Labor for pulling roots, sorting, cleaning, and transporting to market." }
      ]
    },
    {
      id: 20,
      ...
      seasons: ["Winter"],
      seasonText: isArabic ? "الشتاء" : "Winter",
      modalImg: "images/tangerine.jpg",
      growth: isArabic ? "3 - 4 سنوات لبدء الإنتاج التجاري" : "3 - 4 years to start commercial production",
      fertilizer: isArabic ? "سماد عضوي + فوسفور + بوتاسيوم + نيتروجين + عناصر صغرى" : "Organic manure + phosphorus + potassium + nitrogen + micronutrients",
      totalCost: 115000,
      cost: isArabic ? "متوسط تكلفة الفدان: 100,000 - 130,000 جنيه في سنة التأسيس" : "Average cost per feddan: 100,000 - 130,000 EGP in the establishment year",
      method: isArabic ? "اليوسفي من أشجار الموالح التي تحتاج إلى تخطيط جيد من البداية لأنها تبقى في الأرض لسنوات طويلة. تبدأ الزراعة باختيار شتلات مطعومة وسليمة من مشتل موثوق، ثم تجهيز الجور وإضافة السماد العضوي والسوبر فوسفات قبل الغرس. يفضل تركيب ري بالتنقيط لتوفير مياه منتظمة بدون تغريق. بعد الزراعة يتم تثبيت الشتلات وحمايتها من الرياح، ثم يتم الاهتمام بالتسميد التدريجي والتقليم الخفيف ومكافحة الحشرات مثل المن والحشرة القشرية والذبابة البيضاء." : "Tangerine is a citrus tree that requires careful planning because it stays in the field for many years. Cultivation starts with selecting healthy grafted seedlings from a trusted nursery, then preparing planting holes with organic manure and superphosphate before planting. Drip irrigation is preferred to provide regular water without waterlogging. After planting, seedlings are supported and protected from wind, then gradual fertilization, light pruning, and pest control are managed.",
      cultivationSteps: [
        { title: isArabic ? "اختيار الشتلات المطعومة" : "Selecting grafted seedlings", text: isArabic ? "شراء شتلات يوسفي مطعومة على أصل قوي وخالية من التصمغ أو الحشرات، لأن جودة الشتلة تحدد نجاح البستان لسنوات." : "Buy grafted tangerine seedlings on strong rootstock, free from gummosis or pests, because seedling quality affects the orchard for years." },
        { title: isArabic ? "تحديد المسافات وتخطيط البستان" : "Spacing and orchard layout", text: isArabic ? "تحديد أماكن الأشجار بمسافات مناسبة غالبًا 4×5 أو 5×5 متر حسب الصنف ونظام الخدمة لضمان تهوية وضوء جيد." : "Mark tree locations with suitable spacing, usually 4x5 or 5x5 meters depending on variety and management system, to ensure good light and airflow." },
        { title: isArabic ? "تجهيز الجور" : "Planting hole preparation", text: isArabic ? "حفر جور واسعة وخلط التربة الخارجة بسماد عضوي متحلل وسوبر فوسفات، ثم تركها فترة قصيرة قبل الزراعة." : "Dig wide holes and mix excavated soil with decomposed manure and superphosphate, then leave it for a short period before planting." },
        { title: isArabic ? "غرس الشتلات" : "Planting seedlings", text: isArabic ? "غرس الشتلة بحيث تكون منطقة التطعيم أعلى من سطح التربة، ثم الردم والضغط الخفيف حول الجذور بدون دفن التطعيم." : "Plant seedlings with the graft union above soil level, then backfill and gently firm the soil around roots without burying the graft." },
        { title: isArabic ? "تركيب الري بالتنقيط" : "Drip irrigation installation", text: isArabic ? "تركيب نقاطات حول كل شجرة لتوفير ري منتظم، مع زيادة عدد النقاطات تدريجيًا مع كبر حجم الشجرة." : "Install drip emitters around each tree for regular irrigation, increasing emitter number gradually as the tree grows." },
        { title: isArabic ? "التسميد في سنة التأسيس" : "First-year fertilization", text: isArabic ? "استخدام جرعات خفيفة مقسمة من النيتروجين والبوتاسيوم والعناصر الصغرى، وعدم المبالغة في السماد حتى لا تحترق الجذور." : "Use light split doses of nitrogen, potassium, and micronutrients, avoiding excessive fertilization to prevent root burn." },
        { title: isArabic ? "التقليم والحماية" : "Pruning and protection", text: isArabic ? "إزالة الأفرع الضعيفة أسفل منطقة التطعيم، وتثبيت الشتلة بدعامة، ومتابعة المن والحشرة القشرية والذبابة البيضاء." : "Remove weak shoots below the graft union, support the seedling with a stake, and monitor aphids, scale insects, and whiteflies." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "شتلات يوسفي مطعومة" : "Grafted tangerine seedlings", amount: 38000, details: isArabic ? "شراء شتلات مطعومة من مشتل موثوق، وهذا بند أساسي لأن الشتلات الضعيفة تسبب خسارة كبيرة لاحقًا." : "Buying grafted seedlings from a trusted nursery; this is essential because weak seedlings cause major losses later." },
        { id: 2, title: isArabic ? "تخطيط البستان وتجهيز الجور" : "Orchard layout and hole preparation", amount: 14000, details: isArabic ? "تحديد أماكن الأشجار، حفر الجور، وخلط التربة قبل الغرس." : "Marking tree positions, digging holes, and mixing soil before planting." },
        { id: 3, title: isArabic ? "سماد عضوي وسوبر فوسفات" : "Organic manure and superphosphate", amount: 18000, details: isArabic ? "إضافة سماد بلدي متحلل وسوبر فوسفات داخل الجور لتحسين نمو الجذور في البداية." : "Adding decomposed manure and superphosphate in holes to improve early root growth." },
        { id: 4, title: isArabic ? "شبكة ري بالتنقيط" : "Drip irrigation system", amount: 22000, details: isArabic ? "خراطيم، نقاطات، وصلات، ومستلزمات تشغيل لتوفير مياه منتظمة للأشجار." : "Drip lines, emitters, fittings, and operating supplies to provide regular water to trees." },
        { id: 5, title: isArabic ? "عمالة الغرس والتثبيت" : "Planting and staking labor", amount: 8000, details: isArabic ? "عمالة نقل الشتلات، الغرس، الردم، وتثبيت الشتلات بدعامات عند الحاجة." : "Labor for moving seedlings, planting, backfilling, and staking when needed." },
        { id: 6, title: isArabic ? "تسميد سنة التأسيس" : "First-year fertilization", amount: 10000, details: isArabic ? "جرعات نيتروجين وبوتاسيوم وعناصر صغرى خلال السنة الأولى بدون مبالغة." : "Nitrogen, potassium, and micronutrient doses during the first year without excess." },
        { id: 7, title: isArabic ? "مكافحة آفات الموالح" : "Citrus pest control", amount: 9000, details: isArabic ? "مكافحة المن والحشرة القشرية والذبابة البيضاء والأمراض الفطرية عند ظهور الإصابة." : "Control of aphids, scale insects, whiteflies, and fungal diseases when infection appears." },
        { id: 8, title: isArabic ? "متابعة وخدمة أول سنة" : "First-year maintenance", amount: 6000, details: isArabic ? "عزيق خفيف، إزالة حشائش، تقليم بسيط، ومتابعة نمو الشتلات." : "Light hoeing, weed removal, simple pruning, and seedling growth follow-up." }
      ]
    },
    {
      id: 21,
      ...
      seasons: ["Summer"],
      seasonText: isArabic ? "الصيف" : "Summer",
      modalImg: "images/Grapes.webp",
      growth: isArabic ? "2 - 3 سنوات لبدء الإنتاج" : "2 - 3 years to start production",
      fertilizer: isArabic ? "سماد عضوي + بوتاسيوم عالي + نيتروجين متوازن + عناصر صغرى" : "Organic manure + high potassium + balanced nitrogen + micronutrients",
      totalCost: 135000,
      cost: isArabic ? "متوسط تكلفة الفدان: 120,000 - 150,000 جنيه في سنة التأسيس" : "Average cost per feddan: 120,000 - 150,000 EGP (establishment year)",
      method: isArabic ? "العنب من المحاصيل المعمرة التي تعتمد بشكل كبير على نظام التربية والدعامات. تبدأ الزراعة باختيار شتلات قوية، ثم تجهيز الأرض جيدًا وزراعة الشتلات على مسافات منتظمة. يتم إنشاء نظام تعريشة (سلك وخشب أو خرسانة) لرفع النبات وتنظيم النمو. يحتاج العنب إلى تقليم سنوي مهم جدًا لتنظيم الإنتاج، بالإضافة إلى برنامج تسميد يعتمد بشكل كبير على البوتاسيوم لتحسين جودة الثمار." : "Grapes are perennial crops that rely heavily on training systems and support structures. Cultivation starts with selecting strong seedlings, preparing the land, and planting at proper spacing. A trellis system (wires with wooden or concrete posts) is built to support plant growth. Grapes require essential annual pruning to regulate production, along with a fertilization program focused on potassium to improve fruit quality.",
      cultivationSteps: [
        { title: isArabic ? "اختيار الشتلات" : "Selecting seedlings", text: isArabic ? "اختيار شتلات عنب قوية وخالية من الأمراض من مصدر موثوق." : "Select strong, disease-free grape seedlings from a trusted source." },
        { title: isArabic ? "تجهيز الأرض" : "Land preparation", text: isArabic ? "حرث الأرض وتنعيمها وإضافة سماد عضوي قبل الزراعة." : "Plow and prepare the soil with organic manure before planting." },
        { title: isArabic ? "زراعة الشتلات" : "Planting", text: isArabic ? "زراعة الشتلات على مسافات 2×3 أو 2.5×3 متر حسب النظام." : "Plant seedlings at spacing of 2x3 or 2.5x3 meters depending on system." },
        { title: isArabic ? "إنشاء التعريشة" : "Trellis installation", text: isArabic ? "تركيب أعمدة وأسلاك لرفع النبات وتنظيم النمو." : "Install poles and wires to support and train plant growth." },
        { title: isArabic ? "التقليم السنوي" : "Annual pruning", text: isArabic ? "تقليم الأفرع القديمة لتشجيع نمو جديد وتحسين الإنتاج." : "Prune old branches to encourage new growth and better yield." },
        { title: isArabic ? "التسميد والري" : "Fertilization & irrigation", text: isArabic ? "تسميد متوازن مع التركيز على البوتاسيوم، وري منتظم حسب المناخ." : "Balanced fertilization focusing on potassium and regular irrigation." },
        { title: isArabic ? "الحصاد" : "Harvesting", text: isArabic ? "جمع العناقيد عند اكتمال النضج." : "Harvest grape clusters when fully ripe." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "شتلات العنب" : "Grape seedlings", amount: 30000, details: isArabic ? "شراء شتلات جيدة ومناسبة للصنف المطلوب." : "شراء شتلات عالية الجودة" },
        { id: 2, title: isArabic ? "تجهيز الأرض" : "Land preparation", amount: 12000, details: isArabic ? "حرث وتسوية الأرض." : "Plowing and leveling" },
        { id: 3, title: isArabic ? "سماد عضوي" : "Organic manure", amount: 15000, details: isArabic ? "تحسين خصوبة التربة قبل الزراعة." : "Improve soil fertility" },
        { id: 4, title: isArabic ? "نظام التعريشة" : "Trellis system", amount: 40000, details: isArabic ? "أعمدة وأسلاك لتربية العنب." : "Poles and wires for training" },
        { id: 5, title: isArabic ? "أسمدة كيميائية" : "Fertilizers", amount: 15000, details: isArabic ? "بوتاسيوم + عناصر صغرى." : "Potassium and micronutrients" },
        { id: 6, title: isArabic ? "مكافحة" : "Pesticides", amount: 12000, details: isArabic ? "مكافحة البياض الدقيقي والحشرات." : "Control powdery mildew and pests" },
        { id: 7, title: isArabic ? "عمالة وصيانة" : "Labor & maintenance", amount: 11000, details: isArabic ? "تقليم وصيانة التعريشة." : "Pruning and maintenance" }
      ]
    },
    {
      id: 22,
      ...
      fertilizer: isArabic ? "سماد عضوي + NPK متوازن + بوتاسيوم عالي وقت الإثمار + عناصر صغرى (حديد وزنك)" : "Organic manure + balanced NPK + high potassium during fruiting + micronutrients (Fe & Zn)",
      totalCost: 125000,
      cost: isArabic ? "متوسط تكلفة الفدان: 110,000 - 140,000 جنيه في سنة التأسيس" : "Average cost per feddan: 110,000 - 140,000 EGP (establishment year)",
      method: isArabic ? "المانجو من الأشجار المعمرة التي تحتاج تخطيط طويل المدى، وتختلف إدارتها عن باقي المحاصيل لأنها تعتمد على تكوين هيكل شجري قوي في السنوات الأولى. تبدأ الزراعة باختيار شتلات مطعومة من أصناف جيدة، ثم تجهيز الأرض وحفر الجور وإضافة السماد العضوي. يتم غرس الشتلات على مسافات واسعة لضمان التهوية وتقليل الأمراض. خلال السنوات الأولى يتم التركيز على بناء الشجرة بالتقليم الخفيف وليس الإنتاج. التسميد يكون متوازن في البداية ثم يزداد البوتاسيوم مع بداية الإثمار. كما تحتاج الأشجار إلى مكافحة دورية للأمراض مثل البياض الدقيقي والعفن." : "Mango is a perennial tree that requires long-term planning and differs from seasonal crops. It focuses on building a strong tree structure in early years. Cultivation starts by selecting grafted seedlings from good varieties, then preparing land and planting holes with organic manure. Trees are planted with wide spacing for good aeration. During early years, the focus is on tree formation through light pruning rather than fruiting. Fertilization is balanced initially, then potassium increases during fruiting. Trees also require regular disease control such as powdery mildew and rot.",
      cultivationSteps: [
        { title: isArabic ? "اختيار الشتلات المطعومة" : "Selecting grafted seedlings", text: isArabic ? "اختيار شتلات مانجو مطعومة من صنف معروف وخالية من الأمراض لضمان إنتاج مستقر." : "Choose grafted mango seedlings from a known variety and free from diseases." },
        { title: isArabic ? "تحديد المسافات" : "Spacing", text: isArabic ? "زراعة الأشجار على مسافات واسعة (5×5 أو 6×6 متر) لتقليل التزاحم وتحسين التهوية." : "Plant trees at wide spacing (5x5 or 6x6 meters) to reduce crowding and improve airflow." },
        { title: isArabic ? "تجهيز الجور" : "Hole preparation", text: isArabic ? "حفر جور عميقة وخلط التربة بالسماد العضوي قبل الزراعة." : "Dig deep holes and mix soil with organic manure before planting." },
        { title: isArabic ? "غرس الشتلات" : "Planting", text: isArabic ? "غرس الشتلات مع تثبيتها جيدًا وحمايتها من الرياح." : "Plant seedlings firmly and protect them from wind." },
        { title: isArabic ? "تكوين الشجرة" : "Tree training", text: isArabic ? "تقليم خفيف لتشكيل الشجرة في السنوات الأولى بدل التركيز على الإنتاج." : "Light pruning to shape the tree during early years instead of focusing on yield." },
        { title: isArabic ? "التسميد التدريجي" : "Gradual fertilization", text: isArabic ? "تسميد متوازن ثم زيادة البوتاسيوم مع بداية الإثمار." : "Balanced fertilization, then increasing potassium during fruiting." },
        { title: isArabic ? "المكافحة" : "Protection", text: isArabic ? "مكافحة البياض الدقيقي والعفن والحشرات حسب الحاجة." : "Control powdery mildew, rot, and pests when needed." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "شتلات المانجو" : "Mango seedlings", amount: 42000, details: isArabic ? "شراء شتلات مطعومة من صنف جيد مثل عويس أو زبدة." : "Buying grafted seedlings of good varieties like Owais or Zebda." },
        { id: 2, title: isArabic ? "تجهيز الأرض" : "Land preparation", amount: 13000, details: isArabic ? "حرث وتسوية الأرض قبل الزراعة." : "Plowing and leveling the land." },
        { id: 3, title: isArabic ? "حفر الجور" : "Digging holes", amount: 9000, details: isArabic ? "حفر الجور وتجهيزها للزراعة." : "Digging planting holes." },
        { id: 4, title: isArabic ? "سماد عضوي" : "Organic manure", amount: 16000, details: isArabic ? "تحسين التربة قبل الزراعة." : "Improving soil fertility." },
        { id: 5, title: isArabic ? "شبكة ري بالتنقيط" : "Drip irrigation", amount: 20000, details: isArabic ? "تركيب نظام ري مناسب للأشجار." : "Installing irrigation system." },
        { id: 6, title: isArabic ? "أسمدة كيميائية" : "Fertilizers", amount: 13000, details: isArabic ? "NPK + عناصر صغرى." : "NPK and micronutrients." },
        { id: 7, title: isArabic ? "مكافحة" : "Pesticides", amount: 7000, details: isArabic ? "مكافحة الأمراض والحشرات." : "Disease and pest control." },
        { id: 8, title: isArabic ? "عمالة وصيانة" : "Labor & maintenance", amount: 5000, details: isArabic ? "تقليم وخدمة الأشجار." : "Pruning and maintenance." }
      ]
    },
    {
      id: 23,
      ...
      fertilizer: isArabic ? "سماد عضوي خفيف + نيتروجين + بوتاسيوم + عناصر صغرى" : "Light organic manure + nitrogen + potassium + micronutrients",
      totalCost: 95000,
      cost: isArabic ? "متوسط تكلفة الفدان: 80,000 - 110,000 جنيه حسب مصدر الشتلات وطريقة الزراعة" : "Average cost per feddan: 80,000 - 110,000 EGP depending on planting material and system",
      method: isArabic ? "الأناناس محصول استوائي يحتاج حرارة وضوء قوي وتربة خفيفة جيدة الصرف، لذلك لا يناسب الأراضي الثقيلة أو الأماكن المعرضة للصقيع. يزرع غالبًا باستخدام التيجان أو الخلفات وليس بالبذور. قبل الزراعة يتم تجهيز الأرض جيدًا ورفع المصاطب لتحسين الصرف، ثم تترك التيجان أو الخلفات لتجف فترة قصيرة حتى لا تتعفن بعد الزراعة. يحتاج النبات إلى ري خفيف ومنتظم بدون ركود مياه، وتسميد تدريجي لأن نموه بطيء نسبيًا. أهم نقطة في زراعته هي الدفء والصرف الجيد، لأن البرودة أو زيادة المياه تسبب ضعف النمو وتعفن الجذور." : "Pineapple is a tropical crop that needs heat, strong sunlight, and light well-drained soil, so it is not suitable for heavy soils or frost-prone areas. It is usually planted using crowns or suckers, not seeds. Before planting, the land is prepared and raised beds are formed to improve drainage. Crowns or suckers are left to dry briefly to reduce rotting after planting. Pineapple needs light regular irrigation without standing water and gradual fertilization because growth is relatively slow. The most important factors are warmth and good drainage, as cold or excess water causes weak growth and root rot.",
      cultivationSteps: [
        { title: isArabic ? "اختيار التيجان أو الخلفات" : "Selecting crowns or suckers", text: isArabic ? "استخدام تيجان أناناس سليمة أو خلفات قوية وخالية من العفن، لأن جودة الجزء المزروع تؤثر مباشرة على نسبة النجاح." : "Use healthy pineapple crowns or strong suckers free from rot, because planting material quality directly affects success rate." },
        { title: isArabic ? "تجفيف الجزء المزروع" : "Drying planting material", text: isArabic ? "ترك التاج أو الخلفة يومين تقريبًا في مكان ظل وجيد التهوية قبل الزراعة لتقليل احتمالية التعفن." : "Leave crowns or suckers for about two days in a shaded, well-ventilated place before planting to reduce rotting risk." },
        { title: isArabic ? "تجهيز تربة خفيفة ومصاطب" : "Light soil and bed preparation", text: isArabic ? "تجهيز تربة رملية أو خفيفة وعمل مصاطب مرتفعة لتحسين صرف المياه حول الجذور." : "Prepare sandy or light soil and form raised beds to improve water drainage around the roots." },
        { title: isArabic ? "الزراعة على عمق بسيط" : "Shallow planting", text: isArabic ? "غرس قاعدة التاج أو الخلفة في التربة بعمق بسيط مع تثبيت النبات جيدًا بدون دفن القلب." : "Plant the base of the crown or sucker shallowly and firm it well without burying the central crown." },
        { title: isArabic ? "الري الخفيف المنتظم" : "Light regular irrigation", text: isArabic ? "الري بكميات خفيفة ومنتظمة، مع تجنب تجمع المياه تمامًا لأن جذور الأناناس حساسة للتعفن." : "Irrigate lightly and regularly, avoiding standing water completely because pineapple roots are sensitive to rot." },
        { title: isArabic ? "التسميد البطيء" : "Gradual fertilization", text: isArabic ? "إضافة جرعات صغيرة من النيتروجين والبوتاسيوم والعناصر الصغرى على فترات، لأن النبات نموه بطيء ولا يتحمل الزيادة المفاجئة." : "Apply small doses of nitrogen, potassium, and micronutrients gradually because the plant grows slowly and does not tolerate sudden excess fertilization." },
        { title: isArabic ? "الحماية من البرودة والحشائش" : "Cold and weed protection", text: isArabic ? "حماية النباتات من الصقيع والرياح الباردة، مع إزالة الحشائش لأنها تنافس النبات خلال فترة نموه الطويلة." : "Protect plants from frost and cold winds, and remove weeds because they compete with the plant during its long growth period." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "تيجان أو خلفات أناناس" : "Pineapple crowns or suckers", amount: 28000, details: isArabic ? "شراء تيجان أو خلفات سليمة بكثافة زراعة مناسبة للفدان، وهو أهم بند لأن النبات لا يزرع عادة بالبذور." : "Buying healthy crowns or suckers at suitable planting density per feddan; this is the key item because pineapple is usually not grown from seeds." },
        { id: 2, title: isArabic ? "تجهيز التربة والمصاطب" : "Soil and raised bed preparation", amount: 12000, details: isArabic ? "حرث وتنعيم التربة وعمل مصاطب مرتفعة لتحسين الصرف وتقليل تعفن الجذور." : "Plowing, softening soil, and forming raised beds to improve drainage and reduce root rot." },
        { id: 3, title: isArabic ? "سماد عضوي خفيف" : "Light organic manure", amount: 9000, details: isArabic ? "إضافة كمبوست أو سماد متحلل بكميات معتدلة لتحسين التربة بدون زيادة رطوبة أو ملوحة." : "Adding compost or decomposed manure in moderate amounts to improve soil without increasing moisture or salinity." },
        { id: 4, title: isArabic ? "ري بالتنقيط أو ري خفيف منظم" : "Drip or controlled light irrigation", amount: 17000, details: isArabic ? "تجهيز خراطيم تنقيط أو نظام ري بسيط منتظم لأن الأناناس لا يتحمل التغريق." : "Preparing drip lines or a simple controlled irrigation system because pineapple cannot tolerate waterlogging." },
        { id: 5, title: isArabic ? "أسمدة نيتروجين وبوتاسيوم" : "Nitrogen and potassium fertilizers", amount: 12000, details: isArabic ? "جرعات صغيرة ومتكررة من النيتروجين والبوتاسيوم لدعم النمو الخضري وجودة الثمرة." : "Small repeated doses of nitrogen and potassium to support vegetative growth and fruit quality." },
        { id: 6, title: isArabic ? "عناصر صغرى ومنشطات نمو" : "Micronutrients and growth stimulants", amount: 6000, details: isArabic ? "رش أو إضافة عناصر صغرى عند الحاجة خاصة في الأراضي الرملية الفقيرة." : "Applying micronutrients when needed, especially in poor sandy soils." },
        { id: 7, title: isArabic ? "حماية ومكافحة أعفان" : "Protection and rot control", amount: 7000, details: isArabic ? "مكافحة أعفان الجذور والحشرات البسيطة عند ظهور الإصابة، مع متابعة الصرف باستمرار." : "Controlling root rots and minor pests when infection appears, with continuous drainage monitoring." },
        { id: 8, title: isArabic ? "عمالة زراعة ومتابعة طويلة" : "Planting labor and long-term follow-up", amount: 4000, details: isArabic ? "عمالة تجهيز التيجان والزراعة وإزالة الحشائش والمتابعة خلال فترة النمو الطويلة." : "Labor for preparing crowns, planting, weeding, and follow-up during the long growth period." }
      ]
    },
    {
      id: 24,
      ...
      fertilizer: isArabic ? "فوسفور + بوتاسيوم + بكتيريا العقد الجذرية" : "Phosphorus + potassium + nitrogen-fixing bacteria",
      totalCost: 13500,
      cost: isArabic ? "متوسط تكلفة الفدان: 12,000 - 15,000 جنيه" : "Average cost per feddan: 12,000 - 15,000 EGP",
      method: isArabic ? "الفول الأخضر من المحاصيل البقولية التي تساهم في تحسين خصوبة التربة عن طريق تثبيت النيتروجين الجوي في الجذور، لذلك لا يحتاج إلى كميات كبيرة من الأسمدة النيتروجينية. يفضل زراعته في تربة طميية جيدة الصرف. يتم تجهيز الأرض جيدًا ثم زراعة البذور في جور أو سطور. يحتاج إلى ري منتظم بدون تغريق، مع الاهتمام بإضافة الفوسفور في بداية الزراعة لتحفيز تكوين الجذور. من أهم المشاكل التي تواجهه المن والتبقعات الفطرية، لذلك يجب المتابعة المستمرة." : "Fava beans are legume crops that improve soil fertility by fixing atmospheric nitrogen in their roots, so they do not require large amounts of nitrogen fertilizers. They prefer well-drained loamy soil. The land is prepared, then seeds are planted in hills or rows. They need regular irrigation without waterlogging, and phosphorus is important early for root development. Common issues include aphids and fungal leaf spots, requiring continuous monitoring.",
      cultivationSteps: [
        { title: isArabic ? "تجهيز الأرض" : "Land preparation", text: isArabic ? "حرث الأرض جيدًا وتسويتها، مع ترك قوام مناسب للتربة لسهولة إنبات البذور." : "Plow and level the land properly, ensuring suitable soil texture for seed germination." },
        { title: isArabic ? "زراعة البذور" : "Seed planting", text: isArabic ? "زراعة البذور في جور أو سطور بعمق 3–5 سم، مع ترك مسافات مناسبة بين النباتات." : "Plant seeds in hills or rows at 3–5 cm depth with proper spacing." },
        { title: isArabic ? "تلقيح البذور بالبكتيريا" : "Seed inoculation", text: isArabic ? "معاملة البذور ببكتيريا العقد الجذرية قبل الزراعة لتحسين تثبيت النيتروجين." : "Treat seeds with nitrogen-fixing bacteria before planting to enhance nitrogen fixation." },
        { title: isArabic ? "الري المنتظم" : "Regular irrigation", text: isArabic ? "الري كل 7–10 أيام حسب التربة، مع تجنب التغريق خاصة في بداية النمو." : "Irrigate every 7–10 days depending on soil, avoiding waterlogging especially early." },
        { title: isArabic ? "التسميد بالفوسفور" : "Phosphorus fertilization", text: isArabic ? "إضافة الفوسفور في بداية الزراعة لتقوية الجذور وتحسين النمو." : "Apply phosphorus early to strengthen roots and improve growth." },
        { title: isArabic ? "مكافحة المن والأمراض" : "Pest and disease control", text: isArabic ? "مراقبة المن والتبقعات الفطرية والرش عند ظهور الإصابة فقط." : "Monitor aphids and fungal spots and spray only when infection appears." },
        { title: isArabic ? "الحصاد" : "Harvesting", text: isArabic ? "جمع القرون الخضراء عند اكتمال الحجم وقبل الجفاف." : "Harvest green pods when fully grown before drying." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "تقاوي الفول" : "Seeds", amount: 4500, details: isArabic ? "شراء بذور فول بلدي أو محسنة بنسبة إنبات عالية." : "Buying high-germination fava bean seeds." },
        { id: 2, title: isArabic ? "تجهيز الأرض" : "Land preparation", amount: 2500, details: isArabic ? "حرث وتسوية الأرض قبل الزراعة." : "Plowing and leveling the land." },
        { id: 3, title: isArabic ? "بكتيريا العقد الجذرية" : "Rhizobium bacteria", amount: 800, details: isArabic ? "معاملة البذور لتحسين تثبيت النيتروجين." : "Seed treatment to improve nitrogen fixation." },
        { id: 4, title: isArabic ? "سماد فوسفاتي" : "Phosphorus fertilizer", amount: 2200, details: isArabic ? "تحفيز نمو الجذور في بداية الزراعة." : "Enhancing root development early." },
        { id: 5, title: isArabic ? "ري ومياه" : "Irrigation", amount: 1500, details: isArabic ? "تكلفة الري طوال الموسم." : "Irrigation cost throughout the season." },
        { id: 6, title: isArabic ? "مكافحة" : "Pesticides", amount: 1200, details: isArabic ? "مكافحة المن والأمراض الفطرية." : "Control aphids and fungal diseases." },
        { id: 7, title: isArabic ? "عمالة" : "Labor", amount: 800, details: isArabic ? "زراعة وخدمة المحصول." : "Planting and field operations." }
      ]
    },
    {
      id: 25,
      ...
      fertilizer: isArabic ? "سماد عضوي + نيتروجين عالي + فوسفور + بوتاسيوم" : "Organic manure + high nitrogen + phosphorus + potassium",
      totalCost: 78000,
      cost: isArabic ? "متوسط تكلفة الفدان: 70,000 - 85,000 جنيه حسب نوع الشتلات والخدمة" : "Average cost per feddan: 70,000 - 85,000 EGP depending on seedlings and field care",
      method: isArabic ? "الكرنب من محاصيل الخضر الورقية الثقيلة في التغذية، ويحتاج إلى شتلات قوية وتربة جيدة التجهيز. تبدأ الزراعة غالبًا بإنتاج الشتلات في مشتل لمدة 30 إلى 40 يوم، ثم تُنقل للأرض المستديمة بعد تجهيزها بالحرث والسماد العضوي. يحتاج الكرنب إلى مسافات مناسبة حتى تتكون رؤوس كبيرة ومتماسكة، كما يحتاج إلى تسميد نيتروجيني واضح أثناء النمو الورقي، مع عدم إهمال البوتاسيوم لتحسين جودة الرأس. من أهم المشاكل التي يجب متابعتها دودة ورق الكرنب والمن والأعفان." : "Cabbage is a heavy-feeding leafy vegetable crop that needs strong seedlings and well-prepared soil. It usually starts in a nursery for 30 to 40 days, then seedlings are transplanted into the field after plowing and organic manure application. Cabbage requires proper spacing to form large firm heads, and it needs strong nitrogen fertilization during leaf growth while potassium improves head quality. Important issues include cabbage leaf worms, aphids, and rots.",
      cultivationSteps: [
        { title: isArabic ? "إنتاج الشتلات في المشتل" : "Nursery seedling production", text: isArabic ? "زراعة البذور في مشتل أو صواني شتلات لمدة 30–40 يوم حتى تصبح الشتلات قوية وصالحة للشتل." : "Sow seeds in a nursery or trays for 30–40 days until seedlings become strong enough for transplanting." },
        { title: isArabic ? "تجهيز الأرض المستديمة" : "Main field preparation", text: isArabic ? "حرث الأرض جيدًا وتنعيمها وإضافة سماد عضوي متحلل قبل الشتل لتحسين خصوبة التربة." : "Plow and soften the field well, adding decomposed organic manure before transplanting to improve fertility." },
        { title: isArabic ? "الشتل بمسافات مناسبة" : "Transplanting with proper spacing", text: isArabic ? "زراعة الشتلات على مسافة 50–70 سم بين النباتات حتى تأخذ الرأس مساحة كافية للتكوين." : "Transplant seedlings with 50–70 cm spacing so the head has enough space to form properly." },
        { title: isArabic ? "رية الثبات بعد الشتل" : "Settling irrigation", text: isArabic ? "ري الأرض مباشرة بعد الشتل لتثبيت الجذور وتقليل الذبول في الأيام الأولى." : "Irrigate immediately after transplanting to settle roots and reduce wilting during the first days." },
        { title: isArabic ? "التسميد النيتروجيني" : "Nitrogen fertilization", text: isArabic ? "إضافة النيتروجين على دفعات لدعم النمو الورقي وتكوين رأس قوية، مع عدم الزيادة المفرطة حتى لا تزيد الأمراض." : "Apply nitrogen in split doses to support leafy growth and head formation, without excessive use to avoid disease pressure." },
        { title: isArabic ? "مكافحة دودة ورق الكرنب" : "Cabbage worm control", text: isArabic ? "متابعة الأوراق باستمرار لمكافحة الديدان والمن والأمراض الفطرية عند بداية الإصابة." : "Monitor leaves regularly to control worms, aphids, and fungal diseases at the start of infection." },
        { title: isArabic ? "الحصاد عند صلابة الرأس" : "Harvesting firm heads", text: isArabic ? "يتم الحصاد عندما تصبح الرأس صلبة ومتماسكة، مع إزالة الأوراق الخارجية التالفة قبل التسويق." : "Harvest when heads become firm and compact, removing damaged outer leaves before marketing." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "بذور وشتلات كرنب" : "Cabbage seeds and seedlings", amount: 18000, details: isArabic ? "شراء بذور جيدة أو شتلات جاهزة قوية، والتكلفة تختلف حسب الصنف والهجين." : "Buying good seeds or strong ready seedlings; cost varies by variety and hybrid type." },
        { id: 2, title: isArabic ? "تجهيز المشتل أو الصواني" : "Nursery or tray preparation", amount: 7000, details: isArabic ? "تربة زراعة، صواني أو مشتل، ومتابعة الشتلات قبل نقلها للأرض." : "Growing medium, trays or nursery preparation, and seedling care before transplanting." },
        { id: 3, title: isArabic ? "تجهيز الأرض والحرث" : "Land preparation and plowing", amount: 10000, details: isArabic ? "حرث، تنعيم، تسوية، وتخطيط الأرض للشتل." : "Plowing, softening, leveling, and preparing rows for transplanting." },
        { id: 4, title: isArabic ? "سماد عضوي قبل الشتل" : "Organic manure before transplanting", amount: 12000, details: isArabic ? "إضافة سماد بلدي متحلل أو كمبوست لتحسين التربة قبل زراعة الشتلات." : "Adding decomposed manure or compost to improve soil before transplanting." },
        { id: 5, title: isArabic ? "أسمدة نيتروجين وبوتاسيوم" : "Nitrogen and potassium fertilizers", amount: 16000, details: isArabic ? "جرعات نيتروجين لتكوين المجموع الورقي، وبوتاسيوم لتحسين صلابة الرأس." : "Nitrogen doses for leaf growth and potassium to improve head firmness." },
        { id: 6, title: isArabic ? "عمالة شتل وخدمة" : "Transplanting and field labor", amount: 9000, details: isArabic ? "عمالة نقل الشتلات، الشتل، العزيق، وتنظيف الحشائش." : "Labor for moving seedlings, transplanting, hoeing, and weed cleaning." },
        { id: 7, title: isArabic ? "مكافحة ديدان وأمراض" : "Pest and disease control", amount: 8000, details: isArabic ? "مكافحة دودة ورق الكرنب والمن والأعفان عند ظهور الإصابة." : "Control cabbage worms, aphids, and rots when infection appears." },
        { id: 8, title: isArabic ? "حصاد وتنظيف ونقل" : "Harvesting, cleaning, and transport", amount: 8000, details: isArabic ? "عمالة تقطيع الرؤوس، إزالة الأوراق التالفة، وفرز ونقل المحصول." : "Labor for cutting heads, removing damaged leaves, sorting, and transporting the crop." }
      ]
    },
    {
      id: 26,
      ...
      growth: isArabic ? "3 - 5 سنوات لبدء الإنتاج التجاري" : "3 - 5 years to start commercial production",
      fertilizer: isArabic ? "سماد عضوي + فوسفور + بوتاسيوم + نيتروجين متوازن + عناصر صغرى" : "Organic manure + phosphorus + potassium + balanced nitrogen + micronutrients",
      totalCost: 120000,
      cost: isArabic ? "متوسط تكلفة الفدان: 105,000 - 135,000 جنيه في سنة التأسيس" : "Average cost per feddan: 105,000 - 135,000 EGP in the establishment year",
      method: isArabic ? "التفاح من أشجار الفاكهة المعمرة التي تحتاج إلى برودة شتوية مناسبة وأرض جيدة الصرف، لذلك نجاحه يعتمد على اختيار الصنف المناسب للمنطقة. تبدأ الزراعة بشراء شتلات مطعومة سليمة، ثم تجهيز الجور وإضافة السماد العضوي والسوبر فوسفات قبل الغرس. يتم غرس الشتلات أثناء فترة السكون الشتوي، مع تثبيت الشتلة بدعامة وحماية منطقة التطعيم. في السنوات الأولى يكون التركيز على تكوين هيكل قوي للشجرة بالتقليم والتربية، وليس الحصول على محصول كبير مباشرة. يحتاج التفاح إلى برنامج تسميد متدرج ومتابعة دقيقة للمنّ والبياض الدقيقي والجرب." : "Apple is a perennial fruit tree that needs suitable winter chilling and well-drained soil, so success depends on choosing the right variety for the region. Cultivation starts with healthy grafted seedlings, then planting holes are prepared with organic manure and superphosphate. Seedlings are planted during winter dormancy, supported with stakes, and the graft union is protected. In the first years, the focus is on building a strong tree structure through pruning and training rather than heavy production. Apples require gradual fertilization and careful monitoring for aphids, powdery mildew, and apple scab.",
      cultivationSteps: [
        { title: isArabic ? "اختيار الصنف والشتلات" : "Variety and seedling selection", text: isArabic ? "اختيار صنف مناسب للمناخ المحلي وشراء شتلات مطعومة قوية وخالية من الأمراض من مشتل موثوق." : "Choose a variety suitable for the local climate and buy strong disease-free grafted seedlings from a trusted nursery." },
        { title: isArabic ? "تجهيز الجور قبل الزراعة" : "Preparing planting holes", text: isArabic ? "حفر جور واسعة قبل الزراعة وخلط ناتج الحفر بسماد عضوي متحلل وسوبر فوسفات لتحسين بداية نمو الجذور." : "Dig wide holes before planting and mix excavated soil with decomposed manure and superphosphate to support early root growth." },
        { title: isArabic ? "الغرس في فترة السكون" : "Planting during dormancy", text: isArabic ? "زراعة الشتلات في الشتاء قبل خروج البراعم، مع جعل منطقة التطعيم أعلى من سطح التربة وعدم دفنها." : "Plant seedlings in winter before bud break, keeping the graft union above soil level and not burying it." },
        { title: isArabic ? "تثبيت الشتلات والري الأول" : "Staking and first irrigation", text: isArabic ? "تثبيت الشتلات بدعامات لحمايتها من الرياح، ثم ريها مباشرة بعد الغرس لإخراج الفراغات الهوائية حول الجذور." : "Stake seedlings to protect them from wind, then irrigate immediately after planting to remove air pockets around roots." },
        { title: isArabic ? "تكوين هيكل الشجرة" : "Tree training", text: isArabic ? "إجراء تقليم تربية في السنوات الأولى لاختيار أفرع رئيسية قوية تسمح بدخول الضوء والهواء داخل الشجرة." : "Apply training pruning in early years to select strong main branches that allow light and air into the canopy." },
        { title: isArabic ? "التسميد المتدرج" : "Gradual fertilization", text: isArabic ? "إضافة نيتروجين بكميات محدودة في بداية النمو، مع فوسفور وبوتاسيوم وعناصر صغرى حسب حالة الشجرة والتربة." : "Apply limited nitrogen early, along with phosphorus, potassium, and micronutrients according to tree and soil condition." },
        { title: isArabic ? "المكافحة والمتابعة" : "Protection and monitoring", text: isArabic ? "متابعة المنّ والجرب والبياض الدقيقي والأعفان، والرش عند بداية الإصابة لتجنب انتشار المرض." : "Monitor aphids, apple scab, powdery mildew, and rots, spraying at the beginning of infection to prevent spread." }
      ],
      costSteps: [
        { id: 1, title: isArabic ? "شتلات تفاح مطعومة" : "Grafted apple seedlings", amount: 42000, details: isArabic ? "شراء شتلات مطعومة من صنف مناسب للمنطقة، ويفضل أن تكون من مشتل معتمد لتقليل الفاقد." : "Buying grafted seedlings of a variety suitable for the region, preferably from a certified nursery to reduce losses." },
        { id: 2, title: isArabic ? "تجهيز الأرض وتحديد المسافات" : "Land preparation and spacing", amount: 12000, details: isArabic ? "حرث وتسوية الأرض وتحديد أماكن الأشجار بمسافات مناسبة حسب الصنف ونظام التربية." : "Plowing, leveling, and marking tree positions with proper spacing according to variety and training system." },
        { id: 3, title: isArabic ? "حفر الجور وتجهيزها" : "Hole digging and preparation", amount: 9000, details: isArabic ? "حفر الجور وخلط التربة بالسماد العضوي والسوبر فوسفات قبل الغرس." : "Digging holes and mixing soil with organic manure and superphosphate before planting." },
        { id: 4, title: isArabic ? "سماد عضوي وسوبر فوسفات" : "Organic manure and superphosphate", amount: 16000, details: isArabic ? "إضافة كمبوست أو سماد بلدي متحلل مع سوبر فوسفات لتحسين نمو الجذور في البداية." : "Adding compost or decomposed manure with superphosphate to improve early root growth." },
        { id: 5, title: isArabic ? "شبكة ري بالتنقيط" : "Drip irrigation system", amount: 20000, details: isArabic ? "تركيب خراطيم ونقاطات ووصلات لتوفير ري منتظم وتقليل مشاكل زيادة المياه حول الجذور." : "Installing drip lines, emitters, and fittings to provide regular irrigation and reduce excess water around roots." },
        { id: 6, title: isArabic ? "دعامات وحماية الشتلات" : "Stakes and seedling protection", amount: 6000, details: isArabic ? "تثبيت الشتلات بدعامات وحماية منطقة التطعيم من الكسر أو الرياح القوية." : "Supporting seedlings with stakes and protecting the graft area from breakage or strong winds." },
        { id: 7, title: isArabic ? "تسميد ومغذيات أول سنة" : "First-year fertilizers and nutrients", amount: 9000, details: isArabic ? "جرعات نيتروجين خفيفة، بوتاسيوم، فوسفور، وعناصر صغرى حسب احتياج الشتلات." : "Light nitrogen doses, potassium, phosphorus, and micronutrients according to seedling needs." },
        { id: 8, title: isArabic ? "مكافحة وتقليم وصيانة" : "Pest control, pruning, and maintenance", amount: 6000, details: isArabic ? "مكافحة المنّ والجرب والبياض الدقيقي، مع تقليم تربية ومتابعة نمو الشتلات." : "Control aphids, scab, and powdery mildew, with training pruning and seedling follow-up." }
      ]
    }
  ]), [isArabic]);
  ...
  useEffect(() => {
    if (activeFilter === 'all') {
      ...
      setFilteredPlants(plants.filter((item) => item.seasons.includes(activeFilter)));
    }
  }, [activeFilter, plants]);
